...
//:nth-child(3)
$("tr td:nth-of-type(3) input").focus(function() {
...
// use errored2 for End Date not in range error
// use errorsded3 for start date not greater than or equal to end date error
